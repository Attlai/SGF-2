...
Fichier Ajouter_Successeur(Fichier parent,Fichier fils);
void Afficher_liste_successeurs_proc(LISTE_Fichier* succ);
void Afficher_liste_successeurs(Fichier pere);
bool Liste_est_vide(LISTE_Fichier* L);
LISTE_Fichier *Liste_vide();
Fichier Fichier_Vide();
CHEMIN *Aggrandir_chemin(CHEMIN *C,int new_id);
Fichier Trouver_fils(Fichier parent,int id_fils);
...
Fichier Chercher_Fichier_proc(Fichier f_depart,CHEMIN* chemin_destination);
